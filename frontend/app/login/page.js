            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                ...
                <form className='flex flex-col space-y-4'>
                    <div className='flex flex-col'>
                        ...
                        <input type='email' name='email' id='email' required className='border-2 p-2 rounded-md'/>
                    </div>
                    <div className='flex flex-col'>
                        <label className='text-sm font-semibold mb-2'>Password</label>
                        <input type='password' name='password' id='password' required className='border-2 p-2 rounded-md'/>
                    </div>
